				...
				return y()(g.a.mark((function t()
				{
					...
					return g.a.wrap((function(t)
					{
						for(;;) switch (t.prev = t.next)
						{
							...
							case 29:
								(o = e.confData.mode) && e.$electron.ipcRenderer.send("mode-changed", o), e.showStartup || (e.showStartup = !0, e.showNotification("Clash is running in the background", "Enjoy your free time!")), e.getDefaultInterface(), setInterval(e.getDefaultInterface, 3e3), e.spawnUserDefindExes(), e.checkForUpdate()
									.then((function() {}))
									.catch((function(e)
									{
	...
	var B = H.exports,
		...
		V = {
			...
			}),
			{
				...
				{
					return -1 < ["HTTP Port", "SOCKS5 Port", "Home Directory", "GeoIP Database"].indexOf(e.key)
				},
				showPortContrller: function(e)
				{
					return -1 < ["HTTP Port", "SOCKS5 Port"].indexOf(e.key)
				},
				...
				{
					var t = "http";
					"SOCKS5 Port" === e.key && (t = "socks5"), Object(S.exec)("start cmd",
					{
				...
				itemClick: function(e, t)
				{
					...
					else if("HTTP Port" === t.key || "SOCKS5 Port" === t.key)
					{
						var n = "http";
						"SOCKS5 Port" === t.key && (n = "socks5");
